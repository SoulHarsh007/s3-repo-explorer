export default function Loader({className = 'w-5 h-5'}) {
  return (
    <svg
      className={`mr-2 dark:text-gray-200 text-gray-700 motion-safe:animate-spin dark:fill-[#252525] fill-gray-200 ${className}`}
      fill="none"
      viewBox="0 0 100 101"
